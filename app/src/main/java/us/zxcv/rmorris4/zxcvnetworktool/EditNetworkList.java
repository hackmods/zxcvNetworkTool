 ...
 */
public class EditNetworkList extends ArrayAdapter<String> {
    //the lesson I used
    //http://www.learn2crack.com/2013/10/android-custom-listview-images-text-example.html
    private final Activity context;
    private final String[] web;

    public EditNetworkList(Activity context,
    ...
    public View getView(int position, View view, ViewGroup parent) {
       ...
       // View rowView= inflater.inflate(R.layout.list_check, null, true);
        View rowView= inflater.inflate(R.layout.list_network_edit, null, true);
